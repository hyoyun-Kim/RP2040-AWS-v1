...
/* Publish Period */
#define MQTT_PUB_PERIOD 10000    //10s

/* Use SPI DMA */
//#define USE_SPI_DMA // if you want to use SPI DMA
#define MQTT_DOMAIN    "a3uz5t2azg1xdz-ats.iot.us-west-2.amazonaws.com"
#define MQTT_PUB_TOPIC "$aws/things/RP2040_Test1/shadow/get"
#define MQTT_SUB_TOPIC "$aws/things/RP2040_Test1/shadow/get/accepted"
#define MQTT_USERNAME   NULL
#define MQTT_PASSWORD   NULL
#define MQTT_CLIENT_ID  "RP2040_Test1"

#if 0
uint8_t mqtt_domain[] = "a3uz5t2azg1xdz-ats.iot.us-west-2.amazonaws.com";
uint8_t mqtt_pub_topic[] = "$aws/things/RP2040_Test1/shadow/get";
uint8_t mqtt_sub_topic[] = "$aws/things/RP2040_Test1/shadow/get/accepted";
uint8_t *mqtt_username = NULL;
uint8_t *mqtt_password = NULL;
uint8_t mqtt_clientId[] = "RP2040_Test1";
#endif
